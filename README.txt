...
I decided to start from the beginning in this lab. I only took some parts of lab 3 into this lab.

You will start outside the car. You can fly all over the world.
You can directly pic an object, either to press tab (to switch to car view) or click with the mouse to set a box on fire.
...
The examples från jmonkey was wery helpful.
